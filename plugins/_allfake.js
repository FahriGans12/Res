...
handler.all = async function (m) {
	...
	try {
		...
		global.kontak2 = [
         [owner[1], await conn.getName(owner[1] + '@s.whatsapp.net'), ' ', 'fahrizalofc@gmaol.com', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: { // Bagian ini sesuka kalian berkreasi :'v
					...
					body: wm,
					mediaUrl: sgc,
					description: 'RezBotz~伊未',
					previewType: "PHOTO",
					thumbnail: await (await fetch(pic)).buffer(),
					sourceUrl: "https://github.com/Fdev90",					
				}
			}
		}
		global.fpayment = {
		...
		global.fakeig = {
         contextInfo: { externalAdReply: { showAdAttribution: true,
            ...
            mediaType: "VIDEO",
            description: "https://Instagram.com/fdev90", 
            title: 'RezBotz~伊未',
            body: wm,
            thumbnailUrl: pp,
            sourceUrl: sig
...
global.fakefb = {
        ...
        global.fvn = {
            ...
            message: { "liveLocationMessage": { "caption":"RezBotz~伊未","h": `${wm}`, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
            ...
            participant: `0@s.whatsapp.net`, ...(m.chat ? 
            { remoteJid: "status@broadcast" } : {}) },
            message: { "liveLocationMessage": { "title": "RezBotz~伊未","h": wm, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
